    ...
    <div className="bg-gradient-to-br from-[#0E1116] via-[#16213e] to-[#1a1a2e] font-sans min-h-screen text-white relative overflow-hidden">
      ...
      <header className="backdrop-blur-xl bg-[#0e1116]/80 shadow-lg fixed top-0 w-full z-50 border-b border-white/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20">
          ...
          <a href="/" className="flex items-center space-x-3 group">
            ...
            <span className="text-2xl font-bold bg-gradient-to-r from-[#c495e6] to-[#e4bef2] bg-clip-text text-transparent">Nivana</span>
          </a>
          ...
          <nav className="hidden lg:flex space-x-6">
            ...
            <a href="#why-Nivana" className="text-gray-400 hover:text-[#c495e6] transition-all duration-300 font-medium relative group">
              Why Us
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-[#c495e6] to-[#e4bef2] group-hover:w-full transition-all duration-300"></span>
            </a>
      ...
      <section id="how-it-works" className="py-24 relative scroll-mt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              How <span className="bg-gradient-to-r from-[#c495e6] to-[#e4bef2] bg-clip-text text-transparent">Nivana Works</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
      ...
      {/* Why Choose Nivana Section */}
      <section id="why-Nivana" className="py-24 relative bg-gradient-to-b from-transparent to-purple-500/5 scroll-mt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Why Choose <span className="bg-gradient-to-r from-[#c495e6] to-[#e4bef2] bg-clip-text text-transparent">Nivana?</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
      ...
      <section id="faq" className="py-24 relative scroll-mt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="space-y-6">
            {[
              {
                q: "Is Nivana really confidential?",
              ...
              {
                q: "Can I use Nivana on my phone?",
                a: "Yes! Nivana is fully responsive and works on all devices - smartphones, tablets, and computers. You can access your account anywhere, anytime."
              },
              {
      ...
      <footer id="contact" className="bg-[#0a0d12]/80 backdrop-blur-xl py-16 border-t border-white/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-white/10 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Nivana. All rights reserved. Made with 💜 for student wellness.</p>
          </div>
        </div>
      </footer>
