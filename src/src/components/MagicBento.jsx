...
const cardData = [
  ...
  { color: '#060010', title: 'Reports', description: 'Generate detailed insights', label: 'Analysis' },
  { color: '#060010', title: 'API Access', description: 'Developer-friendly endpoints', label: 'Development' },
  { color: '#060010', title: 'Support', description: '24/7 customer assistance', label: 'Help' },
  { color: '#060010', title: 'Performance', description: 'Lightning-fast speeds', label: 'Speed' },
  { color: '#060010', title: 'Customization', description: 'Tailor to your needs', label: 'Flexibility' },
  { color: '#060010', title: 'Scalability', description: 'Grow without limits', label: 'Growth' }
];
